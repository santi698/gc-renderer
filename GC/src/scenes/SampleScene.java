...
public class SampleScene extends Scene {
	final static Point3d spherePos = new Point3d(3,3,3);
	//Lights
	...
	final static Sphere s = new Sphere(spherePos, 6);
	final static Plane p2 = new Plane(new Vector3d(3,0,-1),new Point3d(1, 1, 1));
	...
	//Camera
	final static Camera camera = new PinholeCamera(new Point3d(-1, -1, -1), spherePos, new Vector3d(0,0,1), 1, 30, 30, 1024, 1024);
