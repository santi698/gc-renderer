...
public class SampleScene extends Scene {
	final static Point3d spherePos = new Point3d(0, 0.25, 0.25);
	//Lights
	final static Light[] lights = new Light[] {
						new PointLight(new Point3d(0, 20, 0.25), new Color3f(1,0.8f,0.8f), 3),
						new SpotLight(new Point3d(9,10,-1), new Color3f(1,0.5f,0.5f), 0.35, spherePos, Math.toRadians(10)),
...
//						new DirectionalLight(new Vector3d(0,-10,-1), new Color3f(1,1,1), 0.25)
	...
	//Bodies
	final static Sphere s2 = new Sphere(new Point3d(-0.5, 0.5, 1.5), 0.5); 
	...
	final static Triangle t = new Triangle(new Point3d(0,0.01,0), new Point3d(-1.5,0.01,3), new Point3d(1.5,0.01,3)); //Triángulo en el piso

	final static Body[] bodies = new Body[] {
											new Body(s2, new Matte(new Color3f(0,1,1))), 
											new Body(s, new Metal(new Color3f(0.99f,0.99f,0.05f), 100)),
//											new Body(s, new Glass(new Color3f(0.99f, 0.99f, 0.05f))),
											new Body(p, new Metal(new Color3f(0.25f,0.40f,0.25f), 0.5)),
											new Body(t, new Matte(new Color3f(0.15f,0.01f,0.01f)))
	};

	//Camera
	final static Camera camera = new ThinLensCamera(new Point3d(0, 0.5, 0), spherePos, new Vector3d(0,-1,0), 0.035, 720, 480, Math.toRadians(49.13), 7.1, spherePos);
