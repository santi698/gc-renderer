...
public class SampleScene extends Scene {
	...
	final static Light[] lights = new Light[] {
						new PointLight(new Point3d(0, 0.5, 1), new Color3f(0.8f,0.8f,1f), 0.0001),
						new SpotLight(new Point3d(0,2,0.3), new Color3f(1,1f,1f), 0.005, spherePos, Math.toRadians(45)),
						new SpotLight(new Point3d(-1,2,-1), new Color3f(0.9f,0.9f,1), 0.1, spherePos, Math.toRadians(30)),
