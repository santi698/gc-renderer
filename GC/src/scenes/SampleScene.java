...
public class SampleScene extends Scene {
	...
	final static Light[] lights = new Light[] {
						...
						new SpotLight(new Point3d(3,5,-1), new Color3f(1,0.5f,0.5f), 1, spherePos, Math.toRadians(30)),
						new SpotLight(new Point3d(-1,2,-1), new Color3f(0.5f,0.5f,1), 1, spherePos, Math.toRadians(30)),
//						new DirectionalLight(new Vector3d(0,-10,-1), new Color3f(1,1,1), 0.25)
	...
	final static Plane p2 = new Plane(new Vector3d(1,0,0),new Point3d(-1.5, 0, 0)); //Plano vertical
...
//											new Body(p2, new Material(0, 0, 0, 1, new Color3f(0.25f,0.25f,0.25f), new Lambert()))
	...
	//Camera
	final static Camera camera = new PinholeCamera(new Point3d(0, 3, 0), spherePos, new Vector3d(0,-1,0), 0.5, 480, 480);
