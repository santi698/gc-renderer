...
public class KDNodeBackup extends TraceableTree{

	public BoundingBox bbox;
	public KDNodeBackup left;
	public KDNodeBackup right;
	...
	public KDNodeBackup build(List<? extends Traceable> shapes, int depth) {
		...
		if (shapes.size() == 1) {
			...
			this.left = new KDNodeBackup();
			this.right = new KDNodeBackup();
	...
	public IntersectionContext hit(KDNodeBackup node, Ray ray){
